...
using WeatherApiServer.Polices;

namespace WeatherApiServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WeatherApiServer", Version = "v1" });
            });
            ...
            services.AddSingleton<IAuthorizationHandler, SopeHandler>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WeatherApiServer v1"));
            }
